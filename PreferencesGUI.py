...
from Utilities import playSound, GetUserConfigDir, GetWXVersionFromIni, AddToInitFile, DelToInitFile, install, check_internet
...
class TestApp(wx.App):
	...
	def OnInit(self):
		...
		builtins.__dict__['OPENAI_API_KEY'] = ""
