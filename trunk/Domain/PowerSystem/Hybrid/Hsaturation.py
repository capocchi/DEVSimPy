...
class Hsaturation(DomainBehavior):
	...
	###
  	def intTransition(self):
		...
		if Master.sdb.VERBOSE:print '\x1B[1;34;40m %s intTrans \x1B[0;37;40m'%self.__str__()
	...
	def extTransition(self):
		...
		if Master.sdb.VERBOSE:print '\x1B[1;33;40m %s extTransition \x1B[0;37;40m'%self.__str__()
	...
	###
  	def outputFnc(self):
		...
		if Master.sdb.VERBOSE:print '\x1B[1;34;40m %s outputFnc \x1B[0;37;40m'%self.__str__()
