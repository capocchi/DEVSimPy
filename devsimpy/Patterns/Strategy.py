...
class SimStrategy:
	...
	def simulate(self, T = 1e8):
		...
		raise NotImplementedError(
			f"{self.__class__.__name__}.simulate() must be implemented by a subclass"
		)
...
class SimStrategy1(SimStrategy):
	...
	def simulate(self, T = 1e8):
		...
		if self._simulator is None:
			raise ValueError("Simulator instance must be provided to SimStrategy1.")
...
class SimStrategy2(SimStrategy):
	...
	def simulate(self, T = 1e8):
		...
		if self._simulator is None:
			raise ValueError("Simulator instance must be provided to SimStrategy2.")
...
class SimStrategy3(SimStrategy):
	...
	def simulate(self, T = 1e8):
		...
		if self._simulator is None:
			raise ValueError("Simulator instance must be provided to SimStrategy3.")
...
class SimStrategy4(SimStrategy):
	...
	def simulate(self, T = 1e8):
		...
		if self._simulator is None:
			raise ValueError("Simulator instance must be provided to SimStrategy4.")
...
# ---------------------------------------------------------------------------
# New: Kafka-based distributed strategy derived from SimStrategy3
# ---------------------------------------------------------------------------
...
class SimStrategyKafka(SimStrategy3):
	"""
