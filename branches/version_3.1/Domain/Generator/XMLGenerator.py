...
class XMLGenerator(Generator):
	...
	def __init__(self, fileName=os.path.join(os.getcwd(), "fichier.xml"), line="line", listValues=None, time="time",
				 outPutFrequency=1.0):
		"""
		...
		"""
		if not listValues: listValues = ["temperature", "humidity", "luminosity"]
