...
## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
# DiagramConstantsDialog.py ---
#                     --------------------------------
#                          Copyright (c) 2013
#                           Laurent CAPOCCHI
#                         University of Corsica
#                     --------------------------------
# Version 3.1                                        last modified: 29/01/2013
## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
#
...
import csv
import wx
import Core.Utilities.DSV as DSV
...
class DiagramConstantsDialog(wx.Dialog):
	...
	def OnImport(self, event):
		...
		dlg = wx.FileDialog(self, _("Choose a file"), os.getenv('USERPROFILE') or os.getenv('HOME') or HOME_PATH, "", _("CSV files (*.csv)|*.csv|Text files (*.txt)|*.txt|All files (*.*)|*.*"), wx.OPEN)
	...
	def OnOk(self, evt):
		...
		if D != {}:
			...
			del __builtin__.__dict__[os.path.splitext(self.label)[0]]
