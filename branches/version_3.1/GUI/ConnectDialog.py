...
class ConnectDialog(wx.Frame):
	def __init__(self, parent, id, title, sn="Source", snL=None, tn="Target", tnL=None):
		if not tnL: tnL = [None, None]
		if not snL: snL = [None, None]
		...
		self._combo_box_sn = wx.ComboBox(self, wx.ID_ANY, choices=L1,
										 style=wx.CB_DROPDOWN | wx.CB_READONLY | wx.CB_SORT)
		self._combo_box_tn = wx.ComboBox(self, wx.ID_ANY, choices=L2,
										 style=wx.CB_DROPDOWN | wx.CB_READONLY | wx.CB_SORT)
