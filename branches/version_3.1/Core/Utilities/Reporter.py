...
#                     --------------------------------
# Version 3.1                                        last modified: 05/03/2013
## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
#
...
def ExceptionHook(exctype, value, trace):
	...
	* trace: Trace back info
	...
	ftrace = Utilities.FormatTrace(exctype, value, trace)
	...
	* partially from Editra.dev_tool
	...
	def DoLayout(self):
		...
		*  Do not call this method in your code
		...
		# Objects
		mainmsg = wx.StaticText(self, label=_("Error: Help improve DEVSimPy by clicking on "
										"Report Error\nto send the Error "
	...
	def OnButton(self, evt):
		...
		* If Report Event then email program is opened
		...
		if e_id == wx.ID_CLOSE:
			...
			wx.CallLater(500, wx.GetApp().Destroy(), wx.MenuEvent(wx.wxEVT_MENU_OPEN, wx.ID_EXIT), True)
			self.Close()
		else:
			evt.Skip()
