...
class Preferences(wx.Toolbook):
	...
	"""
	#Todo : refaire la liste, et le toolbook
	def __init__(self, parent):
		"""
			Constructor.
		"""
...
class PreferencesGUI(wx.Frame):
	...
	def __init__(self, parent, title):
		...
		hsizer.Realize()
		vsizer.Add(self.pref, 1, wx.EXPAND | wx.ALL, 5)
