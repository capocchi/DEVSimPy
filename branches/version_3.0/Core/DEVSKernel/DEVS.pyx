...
cdef class BaseDEVS:
	...
	#cdef public integer myID
	#cdef public object IPorts
	#cdef public object OPorts
	#cdef public object myInput
	#cdef public object myOutput
	###
	def __init__(self):
		""" Constructor.
		"""
...
class AtomicDEVS(BaseDEVS):
	...
	def peek(self, object p):
		...
		try:
			v = self.myInput[p]
			#del self.myInput[p]
			# pour couplage multiple de la sortie d'un modèle vers plusieurs modeles
