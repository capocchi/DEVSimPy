...
class FuzzySetOut(DomainBehavior):
	'''	Basic atomic model
	'''
	...
	def extTransition(self):
		...
		if self.cpt == 2:
			...
			if self.msg1.value[0] == 'PG':
				self.msg1.value[0]=0.1
			elif self.msg1.value[0] == 'NG':
				self.msg1.value[0]=-0.1
			elif self.msg1.value[0] == 'PP':
				self.msg1.value[0]=0.05
			elif self.msg1.value[0] == 'NP':
				self.msg1.value[0]=-0.05
			elif self.msg1.value[0] == 'ZR':
				self.msg1.value[0]=0

			if self.msg2.value[0] == 'PG':
				self.msg2.value[0]=0.1
			elif self.msg2.value[0] == 'NG':
				self.msg2.value[0]=-0.1
			elif self.msg2.value[0] == 'PP':
				self.msg2.value[0]=0.05
			elif self.msg2.value[0] == 'NP':
				self.msg2.value[0]=-0.05
			elif self.msg2.value[0] == 'ZR':
				self.msg2.value[0]=0
