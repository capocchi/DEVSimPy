...
latex_documents = [
  ('index', 'PythonPDEVS.tex', 'PythonPDEVS Documentation',
   'Yentl Van Tendeloo', 'manual'),
]
...
man_pages = [
    ('index', 'pythonpdevs', 'PythonPDEVS Documentation',
     ['Yentl Van Tendeloo'], 1)
]
...
texinfo_documents = [
  ('index', 'PythonPDEVS', 'PythonPDEVS Documentation',
   'Yentl Van Tendeloo', 'PythonPDEVS', 'One line description of project.',
   'Miscellaneous'),
]
